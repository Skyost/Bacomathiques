...
\begin{document}
	...
	\header{description}{En mathématiques, la limite d'une suite ou d'une fonction en un point est,
		...
		être un réel ou infini. Nous verrons ainsi dans ce cours toutes les définitions
