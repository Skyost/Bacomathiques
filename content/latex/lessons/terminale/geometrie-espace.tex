...
\begin{document}
	...
	\begin{tip}[Propriétés]
		...
		\begin{itemize}
			...
			\item Pour montrer qu'une droite est orthogonale à un plan, il suffit de montrer que cette droite est orthogonale à deux droites non colinéaires de ce plan.
