...
\begin{document}
	%<*content>
	\lesson{terminale}{1}{suites}{Les suites}
	
	\header{caption}{Les suites sont utilisées dans bien des domaines, notamment celui de l'étude
		des fractales.}
	
	\header{description}{En mathématiques, une suite est une famille d'éléments – appelés ses ``termes''
		– indexée par les entiers naturels. Ce cours va donc vous apprendre comment définir
		une suite et l'étudier. On y verra notamment l'étude du sens de variation, des limites,
		et plus ! \newline Le raisonnement par récurrence est également au programme de ce chapitre.}
