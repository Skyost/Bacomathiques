...
\begin{document}
	...
	\header{description}{L'intégration est une opération très utilisée en mathématiques et permet
		...
		remarquables des intégrales. Attention cependant; il est fortement recommandé
