...
\begin{document}
	%<*content>
	\lesson{terminale}{3}{continuite-derivabilite-convexite}{Continuité, dérivabilité et convexité}

	\header{caption}{Ce chapitre a beaucoup d'applications, notamment dans l'étude de fonctions
		et dans la physique.}

	\header{description}{Il est possible de définir la continuité d'une fonction comme le fait de
		pouvoir tracer sa courbe représentative ``sans lever le crayon''. La notion de
		dérivabilité, elle est plus complexe et sera élaborée dans ce chapitre (on parlera
		notamment de la fonction partie entière, du théorème des valeurs intermédiaires,
		etc...). Ce cours contient également les différentes tables de dérivation ainsi
		que des propriétés sur les fonctions convexes.}
