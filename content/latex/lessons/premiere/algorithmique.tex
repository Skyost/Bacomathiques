...
\begin{document}
	%<*content>
	\lesson{premiere}{8}{algorithmique}{Algorithmique}

	\header{caption}{Les algorithmes sont utilisés dans tout ce qui se rapport à l'informatique,
		comme la conception de sites web !}

	\header{description}{L'algorithmique est l'étude et la production de règles et techniques qui
		...
		des étapes pour résoudre un problème algorithmique. Ce cours va vous permettre
		d'avoir de bonnes notions en Python (et en algorithmique de manière générale) afin
		d'étudier et de programmer des algorithmes par vous-même.}
