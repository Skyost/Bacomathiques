...
\begin{document}
	%<*content>
	\lesson{premiere}{1}{suites}{Les suites}

	\header{caption}{On peut utiliser les suites pour étudier les motifs sur certaines variétés
		de légumes.}
	...
	\header{description}{En mathématiques, une suite est une famille d'éléments — appelés ses ``termes''
		...
		une suite et l'étudier. On y verra notamment l'étude du sens de variation, la représentation
		de suites dans le plan, et plus encore !}
