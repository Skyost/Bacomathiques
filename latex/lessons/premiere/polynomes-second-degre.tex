...
\begin{document}
	%<*content>
	\lesson{premiere}{2}{polynomes-second-degre}{Les polynômes du second degré}
	
	\header{caption}{Les fonctions polynômiales du second degré sont utilisés dans l'aviation
		pour les vols paraboliques entre autres.}
	
	\header{excerpt}{Les fonctions polynômiales du second degré sont parfois appelées trinômes,
		fonctions quadratiques ou encore fonctions du second degré. Ce sont les fonctions
		les plus simples, après les fonctions affines mais leur étude et leurs applications
		n'en sont pas moins très intéressants.\newline Ce cours nous permettra d'établir des
		bases solides (définition, représentation, différentes formes, ...) afin d'étudier
