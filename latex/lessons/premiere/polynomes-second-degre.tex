...
\begin{document}
	...
	\begin{tip}
		...
		\begin{itemize}
			\item Si $a \lt 0$, la fonction est croissante puis décroissante.
			\item Si $a \gt 0$, la fonction est décroissante puis croissante.
		\end{itemize}
	\end{tip}
	...
	\begin{formula}[Propriétés]
		...
		\begin{itemize}
			\item Si $\Delta \lt 0$ alors $f$ n'admet pas de racine réelle.
			\item Si $\Delta = 0$ alors $f$ admet une unique racine réelle : $x_0 = \displaystyle{\frac{-b}{2a}}$.
			\item Si $\Delta \gt 0$ alors $f$ admet deux racines réelles : $x_1 = \displaystyle{\frac{-b - \sqrt{\Delta}}{2a}}$ et $x_2 = \displaystyle{\frac{-b + \sqrt{\Delta}}{2a}}$.
		\end{itemize}
	\end{formula}
	...
	\begin{formula}[Signe d'une fonction du second degré]
		...
		\begin{itemize}
			\item Si $a \lt 0$ : $f(x) \lt 0$ sur $]-\infty; x_1[ \, \cup \, ]x_2; +\infty[$ et $f(x) \gt 0$ sur $]x_1; x_2[$.
			\item Si $a \gt 0$ : $f(x) \gt 0$ sur $]-\infty; x_1[ \, \cup \, ]x_2; +\infty[$ et $f(x) \lt 0$ sur $]x_1; x_2[$.
		\end{itemize}
	\end{formula}
	...
	\begin{tip}
		...
		\begin{itemize}
			\item Si $a \lt 0$, le maximum de $f$ est atteint en $\alpha$ et vaut $\beta$ (donc pour tout $x \in \mathbb{R}$, $f(x) \leq \beta$).
			\item Si $a \gt 0$, le minimum de $f$ est atteint en $\alpha$ et vaut $\beta$ (donc pour tout $x \in \mathbb{R}$, $f(x) \geq \beta$).
		\end{itemize}
	\end{tip}
	...
	\begin{formula}[Sens de variation]
		\begin{itemize}
			\item Si $a \lt 0$ : $f$ est strictement croissante sur $]-\infty; \alpha]$ et est strictement décroissante sur $]\alpha; +\infty]$.
			\item Si $a \gt 0$ : $f$ est strictement décroissante sur $]-\infty; \alpha]$ et est strictement croissante sur $]\alpha; +\infty]$.
		\end{itemize}
	\end{formula}
