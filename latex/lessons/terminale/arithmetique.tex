...
\begin{document}
	...
	\begin{formula}[Théorème de la division euclidienne]
		Soient $a$, $b \in \mathbb{Z}$. On suppose $b \neq 0$. On appelle \textbf{division euclidienne} de $a$ par $b$, l'opération qui à $(a, b)$, associe le couple d'entiers relatifs $(q, r)$ tel que $a = bq + r$ où $0 \leq r \lt |b|$. Un tel couple \textbf{existe} forcément et est \textbf{unique}.
	\end{formula}
	...
	\begin{tip}[Exemple]
		...
		\begin{itemize}
			...
			\item Comme $6 \lt 7$, la division euclidienne est terminée : on a $314 = 7 \times 44 + 6$.
		\end{itemize}
	\end{tip}
	...
	Il existe une manière de déterminer le $\operatorname{PGCD}$ de deux entiers naturels non nuls $a$ et $b$ avec $b \lt a$ appelée \textbf{Algorithme d'Euclide}.
