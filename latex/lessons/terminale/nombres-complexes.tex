...
\begin{document}
	%<*content>
	\lesson{terminale}{nombres-complexes}{Chapitre XIII – Les nombres complexes (Maths expertes)}
	...
	\begin{formula}[Relations]
		...
		\begin{itemize}
			...
			\item $\displaystyle{\overline{\left(\frac{z}{z'}\right)} = \frac{\bar{z}}{\bar{z'}}}$ où $z' \neq 0$
	...
	\begin{formula}[Racines $n$-ièmes de l'unité]
		...
		\newline
		$\displaystyle{\mathbb{U}_n = \left\{ e^{\frac{2i\pi \times 0}{n}}, e^{\frac{2i\pi \times 1}{n}}, e^{\frac{2i\pi \times 2}{n}}, \dots, e^{\frac{2i\pi \times (n-1)}{n}} \right\}}$.
	\end{formula}
