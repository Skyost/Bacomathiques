...
\begin{document}
	...
	\header{excerpt}{Il est possible de définir la continuité d'une fonction comme le fait de
		...
		etc...). \newline Ce cours contient également les différentes tables de dérivation ainsi
