...
\begin{document}
	...
	\header{excerpt}{En mathématiques, les matrices sont des tableaux de nombres qui servent à
		interpréter en termes calculatoires et donc opérationnels les résultats théoriques
		de l'algèbre linéaire et même de l'algèbre bilinéaire. \newpar Dans ce chapitre nous
		étudierons certaines lois et propriétés qui régissent l'algèbre des matrices. Ce
		cours contient également une partie sur les graphes, et permet faire un lien entre
