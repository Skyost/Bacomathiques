...
\begin{document}
    ...
    \begin{formula}[Définition]
      ...
      \begin{itemize}
        \item On dit que $m$ est un \textbf{minorant} de $(u_n)$ si pour tout $n$ : $u_n \gt m$.
        \item On dit que $M$ est un \textbf{majorant} de $(u_n)$ si pour tout $n$ : $u_n \lt M$.
    ...
    \begin{demonstration}
      ...
      \newpar
      Or, comme $(u_n)$ est non majorée, il existe $N$ tel que $u_N > A$. De plus, comme $(u_n)$ est croissante, alors $A \lt u_N \leq u_{N+1} \leq u_{N+2} \leq \dots$
      \newpar
    ...
    \end{tip}
      ...
      \begin{demonstration}[Inégalité de Bernoulli]
        ...
        \newpar
        \textbf{Initialisation :} On teste la propriété au rang $2$ :
        \newpar
        ...
        \newline $\iff (1+x)^{n+1} \geq 1 + (n+1)x + nx^2 \gt 1 + (n+1)x$
        \newpar
        \textbf{Conclusion :}
        \newpar
