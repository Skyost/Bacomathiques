...
\begin{document}
  \begin{tikzpicture}
    \draw[black, thick, line width=2pt, fill=green, fill opacity=0.2] (0,0) circle (350px);
    \draw[black, thick, line width=2pt, fill=green, fill opacity=0.2] (0,-1) circle (300px);
    \draw[black, thick, line width=2pt, fill=green, fill opacity=0.2] (0,-2) circle (250px);
    \draw[black, thick, line width=2pt, fill=green, fill opacity=0.2] (0,-3) circle (200px);
    \draw[black, thick, line width=2pt, fill=green, fill opacity=0.2] (0,-4) circle (150px);
    \draw[black, thick, line width=2pt, fill=green, fill opacity=0.2] (0,-5) circle (100px);
